...
def test_full_in_mem_implementaation(example_snippet: Snippet):
...
def test_load_snippets_returns_empty_when_file_missing_or_empty():
    with TemporaryDirectory() as tmpdir:
        ...
        repo = JSONSnippetRepo(file)
        assert repo._load_snippets(file) == []  # type: ignore
...
def test_add_snippet_with_id_triggers_else_path(monkeypatch, example_snippet):  # type: ignore
    ...
    with TemporaryDirectory() as tmpdir:
        ...
        repo = JSONSnippetRepo(json_path)
